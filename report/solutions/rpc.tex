...
A definition such as in~\cref{code:rpc:capnp-def} does not detail how it used, it acts merely like a `header' file in C-like languages: a list of interfaces, and the contract~\cfref{bg:verification:dbc} for using them.
